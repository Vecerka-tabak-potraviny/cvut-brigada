...
random validation image from that class
(/mnt/data/Public_datasets/imagenet/imagenet_pytorch/val/), and show CLIP's
most probable label (and its probability) using three different label
sets: classes.txt, mod_classes.txt, openai_classes.txt, mod_classes2.txt and
openai_classes2.txt.
"""
...
def pick_random_image(class_number: int, wnids: list[str], val_dir: str = IMAGENET_VAL_DIR) -> str:
